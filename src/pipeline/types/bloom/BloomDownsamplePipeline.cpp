...
#include "BloomDownsamplePipeline.h"
#include <stdexcept>

BloomDownsamplePipeline::~BloomDownsamplePipeline() {
}

void BloomDownsamplePipeline::Create(
    VkDevice device,
...
void BloomDownsamplePipeline::CreateDefaultDebug(
    VkDevice device,
    VkPipelineLayout pipelineLayout
) {
