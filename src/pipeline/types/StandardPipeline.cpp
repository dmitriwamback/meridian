...
std::vector<VkVertexInputAttributeDescription> StandardPipeline::GetAttributeDescriptions() {
...
void StandardPipeline::Create(
    ...
    if (vkCreateGraphicsPipelines(
        ...
        throw std::runtime_error("Failed to create standard graphics pipeline!");
    }
...
void StandardPipeline::CreateDefaultDebug(
    VkDevice device,
    VkRenderPass renderPass,
    VkPipelineLayout pipelineLayout
) {
    Create(device, renderPass, pipelineLayout,
